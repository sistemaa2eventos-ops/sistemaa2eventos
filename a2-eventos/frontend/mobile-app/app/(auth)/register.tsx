...
export default function RegisterScreen() {
    ...
    const handleRegister = async () => {
        ...
        if (!aceiteLGPD) {
            Alert.alert('LGPD', 'Você precisa aceitar os termos de uso e política de privacidade para continuar.');
            return;
        }
                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
                    ...
                    <View style={styles.form}>
                        ...
                        <TouchableOpacity 
                            ...
                            onPress={() => setAceiteLGPD(!aceiteLGPD)}
                            activeOpacity={0.7}
                        >
                            <View style={[
                                styles.checkbox, 
                                { borderColor: theme.icon },
                                aceiteLGPD && { backgroundColor: theme.tint, borderColor: theme.tint }
                            ]}>
                                {aceiteLGPD && <Ionicons name="checkmark" size={14} color="white" />}
                            </View>
                            <ThemedText style={styles.lgpdText}>
                                Li e aceito as <ThemedText style={{ color: theme.tint, fontWeight: '600' }}>Políticas de Privacidade</ThemedText> e o uso de dados para fins de gestão do evento.
                            </ThemedText>
                        </TouchableOpacity>
