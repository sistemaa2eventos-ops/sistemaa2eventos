-- ============================================
-- FASE 2: COMPLETA - Funções Corrigidas
-- ============================================
-- Tempo: ~20 minutos
-- Risco: Baixo (sem mudanças de lógica, apenas segurança)

-- 1️⃣  REGISTRAR_ACESSO_ATOMICO - Adicionar search_path + Validação
-- =====================================================
...
-- 2️⃣  BUSCAR_PESSOA_POR_ID_PREFIXO - Mudar para SECURITY INVOKER
-- =====================================================
-- Esta é uma busca pública, não precisa de SECURITY DEFINER
...
-- 3️⃣  RECONCILE_TRANSACTION - Adicionar search_path + Validação de Role
-- =====================================================
CREATE OR REPLACE FUNCTION public.reconcile_transaction(t_id uuid)
RETURNS jsonb AS $$
DECLARE
    v_pessoa_id UUID;
    v_updated_count INT;
...
-- 4️⃣  RECORD_AUDIT_LOG - Adicionar search_path
-- =====================================================
-- Esta é uma função trigger (chamada automaticamente), não precisa de validação extra
...
-- 5️⃣  HANDLE_SYNC_USER_CLAIMS - Adicionar search_path
-- =====================================================
-- Esta é uma função trigger (chamada automaticamente por INSERT em perfis)
...
-- 6️⃣  HANDLE_NEW_EVENT_MODULES - Adicionar search_path
-- =====================================================
-- Esta é uma função trigger (chamada automaticamente por INSERT em eventos)
...
-- 7️⃣  IS_MASTER - Adicionar search_path
-- =====================================================
-- Esta é uma função helper para verificar se o usuário é master
...
-- PRÓXIMAS AÇÕES
-- =====================================================
-- 1. Testar todas as funções no staging
