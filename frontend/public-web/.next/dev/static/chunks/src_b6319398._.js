...
function OnboardingForm({ token, initialData }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError('');
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/auth/onboarding/${token}`, {
                ...formData,
...
_s(OnboardingForm, "Aqbu9IDxC8QZT/HlIEm1Yx3udJI=", false, function() {
    return [
...
//# sourceMappingURL=src_b6319398._.js.map