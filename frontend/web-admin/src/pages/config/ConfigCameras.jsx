...
const ConfigHardware = () => {
    ...
    const fetchDevices = async () => {
        ...
        try {
            ...
            console.error('Erro ao buscar hardware edge:', error);
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleSave = async (e) => {
        ...
        if (!eventoId) {
            alert("Selecione um evento na home primeiro!");
            return;
        }
        ...
        try {
            ...
            alert("Configurações de Edge salvas. O driver reiniciará os nós.");
            await fetchDevices(); // Reload p refrescar ids gerados

        } catch (error) {
            console.error('Erro edge config:', error);
            alert("Ocorreu um problema ao salvar as configurações");
        } finally {
            setSaving(false);
        }
    };
