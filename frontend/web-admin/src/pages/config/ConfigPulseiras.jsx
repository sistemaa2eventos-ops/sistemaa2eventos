...
const ConfigPulseiras = () => {
    ...
    const loadData = async () => {
        try {
            ...
            console.error('Erro ao buscar metadados das pulseiras:', error);
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            console.error('Erro ao provisionar pulseira:', error);
        ...
        <Box sx={{ p: 4, maxWidth: 1000, margin: '0 auto' }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 4 }}>
                <PageHeader
                    ...
                    breadcrumbs={[{ text: 'Configurações' }, { text: 'Credenciamento' }, { text: 'Pulseiras' }]}
                />
                <NeonButton
                    startIcon={<AddIcon />}
